...
<p>L'association Muse&Si, déclarée auprès de la préfecture de Montbéliard sous le numéro 25200
dont le siège social est situé : 4 place Tharradin 25200
n° de téléphone : +3371696471
adresse mail : david.philippe02@edu.univ-fcomte.fr
représentée par David Philippe, Responsable communication
1.3 Hébergeur (ci-après « l'hébergeur ») :
Muse&Si est hébergé par infomaniak, dont le siège social est situé 26 RUE DE L'ESPIGOULIER Charleval.
1.4 Délégué à la protection des données (DPO) :
Un délégué à la protection des données : David Philippe, david.philippe02@edu.univ-fcomte.fr, est à votre
...
vidéo, sons, ainsi que toutes les applications informatiques qui pourraient être utilisées pour faire fonctionner
ce site et plus généralement tous les éléments reproduits ou utilisés sur le site sont protégés par les lois en
...
pour l'éditeur de ne pas engager de procédure dès la prise de connaissance de ces utilisations non autorisées
ne vaut pas acceptation desdites utilisations et renonciation aux poursuites.</p>
...
pourra se retourner contre vous pour obtenir l'indemnisation de tous les préjudices, sommes, condamnations
et frais qui pourraient découler de cette procédure.</p>
<h3>Article 6 - Liens hypertextes</h3>
<p>La mise en place par les utilisateurs de tous liens hypertextes vers tout ou partie du site est autorisée par
...
d'aucun droit sur le contenu présent dans le lien.</p>
<h3>Article 7 - Collecte et protection des données</h3>
<p>Vos données sont collectées par l'association Muse&Si.
...
- numéro de téléphone
- date de naissance
- sexe, instruments de musiques
- données financières : dans le cadre du paiement des produits et prestations proposés sur la Plateforme, celleci enregistre des données financières relatives à la carte de crédit de l'utilisateur.
Un délégué à la protection des données : David Philippe, david.philippe02@edu.univ-fcomte.fr, est à votre
disposition pour toute question relative à la protection de vos données personnelles.</p>
...
4 place Tharradin 25200 .
Ou par email, à l’adresse :
Vous pouvez aussi vous adresser à notre délégué à la protection des données : David Philippe, david.
philippe02@edu.univ-fcomte.fr, qui est à votre disposition pour toute question relative à la protection de vos
...
complexité de la demande et/ou le nombre de demandes l'exigent.</p>
</div>
    `,
    data(){
        return{
